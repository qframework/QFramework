...
function QApp()
{
    ...
    this.evals = function ( delay, script)   
    {
        ...
        this.serverko.evals(delay , script);
        return this.serverko;
    }
    this.evasl_ = function ( delay, script)   
    {
        //this.appendEvent( 101 , delay , script );
        this.serverko.evals_(delay , script);
        return this.serverko;
    }    
    ...
    this.scriptAdd = function(wdir , script , name)
    {
...
console.log( " Qs "+ Q.serverko.clientbuffer.toString() + Q.serverko.clientbuffer.length );

function Q_serverko_connect(userID)
{
    console.log( " Qs2 "+ Q.serverko.clientbuffer.toString() + Q.serverko.clientbuffer.length );
    Q.serverko.onClientConnected(userID , Q.serverko);
}

function Q_serverko_disconnect(userID)
{
    Q.serverko.onClientDisconnected(userID, Q.serverko);
}

Q.handlers.onUserJoined.push(Q_serverko_connect);
Q.handlers.onUserLeft.push(Q_serverko_disconnect);
